...
writeDataTable(wb, 2, x = r.borrowersBy.StatusOfLoans , startRow = 23,
               startCol = 1,  withFilter = FALSE, tableStyle =  "TableStyleMedium2")

addStyle(wb, sheet = "Analysis_By_Loan", style = totals_style, rows = 24, cols = 1:ncol(r.borrowersBy.StatusOfLoans),stack = TRUE)

addStyle(wb, sheet = "Analysis_By_Loan", style = percentage_rows, rows = c(24,25,26,27,28,29,30,31,32), cols = c(4) ,stack = TRUE,gridExpand = TRUE)

addStyle(wb, sheet = "Analysis_By_Loan", style = thousands_rows, rows = c(24,25,26,27,28,29,30,31,32), cols = c(6,7) ,stack = TRUE,gridExpand = TRUE)
...
writeDataTable(wb, 2, x = r.byLoan.GBVclusters , startRow = 35,
               startCol = 1,  withFilter = FALSE, tableStyle =  "TableStyleMedium2")

addStyle(wb, sheet = "Analysis_By_Loan", style = totals_style, rows = 36, cols = 1:ncol(r.byLoan.GBVclusters),stack = TRUE)

addStyle(wb, sheet = "Analysis_By_Loan", style = percentage_rows, rows = c(36,37,38,39), cols = c(3) ,stack = TRUE,gridExpand = TRUE)

addStyle(wb, sheet = "Analysis_By_Loan", style = thousands_rows, rows = c(36,37,38,39), cols = c(5,6) ,stack = TRUE,gridExpand = TRUE)
...
writeDataTable(wb, 2, x = r.borrowersBy.Area , startRow = 43,
               startCol = 1,  withFilter = FALSE, tableStyle =  "TableStyleMedium2")

addStyle(wb, sheet = "Analysis_By_Loan", style = totals_style, rows = 44, cols = 1:ncol(r.borrowersBy.Area),stack = TRUE)
...
writeDataTable(wb, 2, x = r.byLoans.pivot_table , startRow = 48,
               startCol = 1,  withFilter = FALSE, tableStyle =  "TableStyleMedium2")

addStyle(wb, sheet = "Analysis_By_Loan", style = totals_style, rows = 49, cols = 1:ncol(r.byLoans.pivot_table),stack = TRUE)

addStyle(wb, sheet = "Analysis_By_Loan", style = thousands_rows, rows = c(49,50,51), cols = c(2,3,4) ,stack = TRUE,gridExpand = TRUE)
